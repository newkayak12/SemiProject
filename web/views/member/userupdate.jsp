	...
	<div id="user-modify-container">
		<form action="<%=request.getContextPath() %>/sign/modify/end" method="post">
			...
			<div id ="modi-input-container">
				...
				<input class="input_style" type="text" name="userphone" placeholder="핸드폰번호" value="<%=user.getUserPhone() %>"><br>
			
				<p class="input_txt">주소</p>
				<input class="input_style " type="text" name="userzip" placeholder="우편번호"value="<%=user.getUserZip() %>"><button class="smallBgtn_syle grey">우편번호 검색</button><br>
			...
			<div id="join_submit_section">
				<input class="bigBtn_syle blue" type="submit" value="회원수정하기">
